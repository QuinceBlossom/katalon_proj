...
// 3. Standard button
// 4. Floating button
// 4.1 Floating button activation
// 4.2 Floating button Sync position
// 4.3 Cancel Floating button
...
Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - Standard panel'), 1000)

Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - Floating button'), 1000)

Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - Floating button (1)'), 1000)

Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - Floating button Sync position'), 1000)
