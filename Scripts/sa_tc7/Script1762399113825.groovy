...
Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - Layout  Right (1)'), 2000)

Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - Layout Left (1)'), 2000)
