...
// 2> Custom 
// 3> Panel pulse 
// 3.1> Bluetooth metronome 
// 3.2> Show toolbar functions 
// 3.3> App volume
...
Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - Expanded panel'), 1000)

Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - Bluetooth metronome'), 1000)

Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - Show toolbar functions'), 1000)

Mobile.tap(findTestObject('Object Repository/Extensions/android.widget.TextView - App volume'), 1000)
